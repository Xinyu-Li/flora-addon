...
(function ($, window, document, undefined) {
    ...
    $.extend(
        altEditor.prototype,
        {
            ...
            */
            createDialog: function(columnDefs, _title, buttonCaption, closeCaption, buttonClass, formName) {
                ...
                var fill = function () 
                {
                    ...
                    $(selector).find('.modal-title').html(_title);
                    $(selector).find('.modal-body').html(data);
                    $(selector).find('.modal-footer').html(btns);
            ...
            _deleteRowCallback: function (response, status, more) {
                if  (response == "error"){
                    alertify.alert("Error: It looks like there is a problem deleting this record.");
                }else{
                    var selector = this.modal_selector;
            ...
            _addRowCallback: function (response, status, more) {
                ...
                if  (response == "error"){
                    alertify.alert("Error: This looks like a duplicate entry. Please check again.");
                }else{
